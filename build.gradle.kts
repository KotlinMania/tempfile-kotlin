...
kotlin {
    ...
    val xcf = XCFramework("Tempfile")

    macosArm64 {
        binaries.framework { baseName = "Tempfile"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Tempfile"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Tempfile"
        flattenPackage = "io.github.kotlinmania.tempfile"
    }

    android {
        namespace = "io.github.kotlinmania.tempfile"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "tempfile-kotlin", version.toString())

    pom {
        name.set("tempfile-kotlin")
        description.set("Kotlin Multiplatform port of Stebalien/tempfile - A library for managing temporary files and directories")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/tempfile-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/tempfile-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/tempfile-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/tempfile-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.tempfile.codeql
