...
This file is the quick-reference operating contract for tempfile-kotlin. The longer
...
tempfile-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`tempfile`](https://crates.io/crates/tempfile). Upstream Rust is the behavioral oracle while the
